...
/HDD-2TB/wajih/bin/hadoop fs -rm -r pr_vector
/HDD-2TB/wajih/bin/hadoop fs -rm -r tempr
/HDD-2TB/wajih/bin/hadoop fs -rm -r pr_distr
/HDD-2TB/wajih/bin/hadoop dfs -rm -r prOutput
...
experiment(){
	...
	STATS_DIR=$LOG_PATH_H/PageRank-Mar3-nocgroups
	...
	/HDD-2TB/wajih/bin/hadoop jar /HDD-2TB/PEGASUS/pegasus-2.0.jar pegasus.PagerankNaive \
		...
		-D mapreduce.task.io.sort.factor=${IO_SORT} \
		 /$INPUT/edges tempr prOutput $PAGES $NO_REDUCERS 1 nosym new   2>&1 | tee $FINAL_DIR/exp.txt
...
R_START=1
PAGES=16000000
#INPUT=HiBench/Pagerank/Input1 # 14 GIGS
INPUT=HiBench/Pagerank/pagerank13.6GB
...
#cgroup_clean
#   for job 1
#   Assuming 8101236028 map output
#   8% 18% 30%   35% 45%  60%   70%  80% 90%   98%  110% 150%
#for CGROUP_LIMIT in 2402 4156 6260 7137 8890 11521 13274 15028 16781 18184 20288 27302; 

#for JVM_MAX_R in 789 1579 2368 3316 6948 11055 14213 17372 23689 30006 31270 33165 42641
for JVM_MAX_R in 418 836 1254 1755 3679 5852 7525 9197 12542 15886 17558 22575
do  
...
#
#cgroup_clean
#for CGROUP_LIMIT in 1200 1500 2000 4000 5000 10000 14000 20000 25000 30000 60000 ; do  EXP_NO=1; RED_M=$((${CGROUP_LIMIT} - 500)) ; JVM_MAX_R=$(($CGROUP_LIMIT - 1000));run ;done
#
